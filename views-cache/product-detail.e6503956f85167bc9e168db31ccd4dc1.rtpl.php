                        ...
                        <div class="col-sm-6">
                            <div class="product-images">
                                <div class="product-main-img">
                                    <img src="/res/site/img/product/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.jpg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-category">
                                    <p>Categorias: <a href="/categories/<?php echo htmlspecialchars( $categories["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $categories["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                                </div> 
