    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="/res/site/img/TESTE.png" id="teste">Mega</a>Click</h1>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/MegaClick" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://twitter.com/MegaClick" target="_blank"><i class="fa fa-twitter"></i></a>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2017 Mega Click. <a href="http://www.MegaClick.com.br" target="_blank">MegaClick.com.br</a></p>
                    </div>
                </div>
